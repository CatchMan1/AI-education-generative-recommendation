...
class Trainer(object):
    ...
    def __init__(self, params, model, data_num):
        self.params = params
        self.model = model
        ...
        self.lr_scheduler_type = params["lr_scheduler_type"]

        self.weight_decay = params["weight_decay"]
        self.epochs = params["epochs"]
        self.warmup_steps = params["warmup_epochs"] * data_num
        self.max_steps = params["epochs"] * data_num

        self.save_limit = params["save_limit"]
        self.best_save_heap = []
        self.newest_save_queue = []
        self.eval_step = min(params["eval_step"], self.epochs)
...
def train(params):
    ...
    """build dataset"""
    data = EmbDataset(params["data_path"])
    model = RQVAE(in_dim=data.dim,
                  num_emb_list=params["num_emb_list"],
                  e_dim=params["e_dim"],
                  ...
                  sk_epsilons=params["sk_epsilons"],
    ...
    data_loader = DataLoader(data,num_workers=params["num_workers"],
                             ...
                             pin_memory=True)
    trainer = Trainer(params, model, len(data_loader))
